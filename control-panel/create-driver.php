...
$DRIVERS = new Driver(NULL);
$DRIVER = $DRIVERS->all();
//$DRIVERS = $DRIVER->getDriverById($id);

//
//$DRIVER_TYPE = new DriverType(NULL);
...
<html> 
    <head>
        ...
        <title>Add New Driver - Tour Sri Lanka</title>
        <!-- Favicon-->
...
<!--                                    <div class="row clearfix">
                                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                            <label for="tourtype">Driver Type</label>
                                        </div>
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7"> 
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="file" id="image_name" class="form-control" name="banner_image"  required="true">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<!--                                            <input type="hidden" name="type"  value="<?php echo $id; ?>"/>-->
                                            <input type="submit" name="create" class="btn btn-primary m-t-15 waves-effect" value="Add Driver"/>
                                        </div>
                                    </div>
                                    <hr/>
                                </form>
