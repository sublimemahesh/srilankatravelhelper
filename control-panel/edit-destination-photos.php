                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body row">
                                <form class="form-horizontal col-sm-9 col-md-9" method="post" action="post-and-get/destination-photos.php" enctype="multipart/form-data"> 
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="caption" class="form-control" placeholder="Enter name" value="<?php echo $DESTINATION_PHOTOS->caption; ?>"  name="caption"  >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                            <input type="hidden" id="id" value="<?php echo $DESTINATION_PHOTOS->id; ?>" name="id"/>
                                            <input type="hidden" id="authToken" value="<?php echo $_SESSION["authToken"]; ?>" name="authToken"/>
                                            <input type="hidden" id="oldImageName" value="<?php echo $DESTINATION_PHOTOS->image_name; ?>" name="oldImageName"/>
                                            <input type="hidden" id="sort" value="<?php echo $DESTINATION_PHOTOS->sort; ?>" name="sort"/>
