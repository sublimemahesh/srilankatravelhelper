...
<html> 
    <head>
        ...
        <title>Tour Date photos -srilankatravelhelper</title>
        <!-- Favicon-->
                                        ...
                                        foreach ($TOUR_DATE_PHOTO as $key => $tour_date_photo) {
                                            ...
                                            <div class="col-md-3"  id="div<?php echo $tour_date_photo['id']; ?>">
                                                ...
                                                <div class="img-caption">
                                                    ...
                                                    <div class="d">
                                                        <a href="#" class="delete-tour-date-photo" data-id="<?php echo $tour_date_photo['id']; ?>"> <button class="glyphicon glyphicon-trash delete-btn"></button></a>
                                                        <a href="edit-tour-date-photo.php?id=<?php echo $tour_date_photo['id']; ?>"> <button class="glyphicon glyphicon-pencil edit-btn"></button></a>
                                                        <a href="arrange-tour-date-photos.php?id=<?php echo $id; ?>">  <button class="glyphicon glyphicon-random arrange-btn"></button></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php
