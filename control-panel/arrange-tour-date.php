...
<html> 
    <head>
        ...
        <title>Arrange Tour Date -srilankatravelhelper</title>
        <!-- Favicon-->
                        ...
                        <div class="card">
                            <div class="header">
                                ...
                                <ul class="header-dropdown">
                                    <li class="">
                                        <a href="view-tour-date.php?id=<?php echo $id ?>">
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/tour-dates.php" class="form-horizontal" >
                                            ...
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    ...
                                                    if (count($TOUR_DATE) > 0) {
                                                        foreach ($TOUR_DATE as $key => $img) {
                                                            ?>
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    <span class="number-class">(<?php echo $key + 1; ?>)</span>
                                                                    <img class="img-responsive" src="../upload/tour-package/date/<?php echo $img["image_name"]; ?>" alt=""/>
