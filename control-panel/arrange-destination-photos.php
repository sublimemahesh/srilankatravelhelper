...
$a = $DESTINATION_PHOTOS->getDestinationByDestinationTypePhotos($id);
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    <?php
                                                    if (count($DESTINATION_PHOTOS->getDestinationByDestinationPhotos($id)) > 0) {
                                                        foreach ($DESTINATION_PHOTOS->getDestinationByDestinationPhotos($id) as $key => $destination_photo_photo) {
                                                            ?>
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    <span class="number-class">(<?php echo $key + 1; ?>)</span>
                                                                    <img class="img-responsive" src="../upload/destination-photos/<?php echo $destination_photo["image_name"]; ?>" alt=""/>
                                                                    <input type="hidden" name="sort[]"  value="<?php echo $destination_photo["id"]; ?>" class="sort-input"/>
