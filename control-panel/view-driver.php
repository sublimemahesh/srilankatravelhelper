                        ...
                        <div class="card">
                            ...
                            <div class="body"> 
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">                                                                        
                                            <div class="form-group">
                                                <div class="form-line"><img src="../upload/drivers/<?php echo $DRIVER->profile_picture; ?>" id="picture_name" class="view-edit-img img img-responsive img-thumbnail" name="image_name" alt="old image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
