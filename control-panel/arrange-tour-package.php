...
<html> 
    <head>
        ...
        <title>Arrange Tour Package -srilankatravelhelper</title>
        <!-- Favicon-->
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/tour-package.php" class="form-horizontal" >
                                            ...
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    ...
                                                    if (count($TOUR_PACKAGE->all()) > 0) {
                                                        foreach ($TOUR_PACKAGE->all() as $key => $img) {
                                                            ?>
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    <span class="number-class">(<?php echo $key + 1; ?>)</span>
                                                                    <img class="img-responsive" src="../upload/tour-package/<?php echo $img["image_name"]; ?>" alt=""/>
