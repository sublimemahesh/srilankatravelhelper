...
$id = $_GET['id'];
 ...
 $DRIVER_PHOTOS = DriverPhotos::getDriverByDriverPhotos($id);
...
<html> 
    <head>
        ...
        <title>Arrange Driver Photos-srilankatravelhelper</title>
        <!-- Favicon-->
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/driver-photos.php" class="form-horizontal" >
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                 <?php
                                                    if (count($DRIVER_PHOTOS) > 0) {
                                                        foreach ($DRIVER_PHOTOS as $key => $driver_photos) {
                                                            ...
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    ...
                                                                    <img class="img-responsive" src="../upload/driver-photos/<?php echo $driver_photos["image_name"]; ?>" alt=""/>
                                                                    
                                                                    <input type="hidden" name="sort[]"  value="<?php echo $driver_photos["id"]; ?>" class="sort-input"/>
