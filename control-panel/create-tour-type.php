...
<html> 
    <head>
        ...
        <title>Add New Tour Type - www.srilankatourism.travel</title>
        <!-- Favicon-->
                                ...
                                <form class="form-horizontal"  method="post" action="post-and-get/tour-type.php" enctype="multipart/form-data"> 
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="name" class="form-control" placeholder="Enter Tour Type" autocomplete="off" name="name" required="TRUE">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="name" class="form-control" placeholder="Enter Short Description" autocomplete="off" name="short_description" required="TRUE">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
