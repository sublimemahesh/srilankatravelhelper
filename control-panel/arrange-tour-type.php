...
<html> 
    <head>
        ...
        <title>Arrange Tour Type - www.srilankatourism.travel</title>
        <!-- Favicon-->
            ...
            <div class="container-fluid">  
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Arrange Tour Type</h2>
                                <ul class="header-dropdown">
                                    <li class="">
                                        <a href="manage-tour-type.php?id=<?php echo $id ?>">
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/tour-type.php" class="form-horizontal" >
                                            ...
                                            <div class="col-md-12 arrange-container">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 text-center" style="margin-top: 19px;">
                                                        <input type="submit" class="btn btn-info" id="btn-submit" value="Save Tour Types" name="save-data">
                                                    </div>
                                                </div>
                                            </div>
                                        </div> 
