...
if (!Visitor::authenticate()) {
    if ($_GET['back'] === 'tourreview') {
        $_SESSION["back_url"] = 'http://www.toursrilanka.travel/visitor/manage-tour-package-reviews.php?tour=' . $id;
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="panel panel-green profile-panel tourpackreview">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 review-add-section" id="review-add-section-tour">
