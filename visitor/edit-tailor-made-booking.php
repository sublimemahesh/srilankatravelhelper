...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Edit Tailor Made Booking  || Visitor DashBoard</title>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-green profile-panel">
                            <div class="panel-heading ">
                                Edit Tailor Made Booking (#<?php echo $BOOKING->id; ?>)
                            </div>
                            <div class="panel-body">
                                <form method="post" action="post-and-get/tailor-made-booking.php"  enctype="multipart/form-data">
                                    ...
                                    <div class="row form-data">
                                        ...
                                        <ul>
                                            ...
                                            foreach ($places as $place) {
                                                ...
                                                ?>
                                                <li><a href="../destination-type-one-item-view-page.php?id=<?php echo $place; ?>" target="_blank" ><?php echo $DESTINATION->name; ?></a></li>
                                                <?php
                                            }
                                            ?>
                                        </ul>
                                    ...
                                    <div class="row form-data">
                                        <label>Price</label>
                                        <input type="text" name="price" id="price" class="form-control" placeholder="Enter Price" value="<?php echo $BOOKING->price; ?>" disabled="" />
                                    </div>
                                    <div class="row form-data">
