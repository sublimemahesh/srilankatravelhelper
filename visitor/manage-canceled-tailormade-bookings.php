...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Manage Canceled Tailor Made Bookings || Visitor DashBoard</title>
                    ...
                    <div class="col-md-12 col-sm-12">
                        ...
                        <div class="panel panel-green profile-panel">
                            <div class="panel-heading ">
                                Manage Canceled Tailor Made Bookings
                            </div>
                            <div class="panel-body">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            foreach (TailorMadeTours::getCanceledBookingsByVisitor($VISITOR->id) as $key => $booking) {
